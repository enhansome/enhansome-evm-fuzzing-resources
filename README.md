# Awesome EVM Fuzzing Resources with stars
...
* [Foundry](https://github.com/foundry-rs/foundry) ⭐ 10,559 | 🐛 321 | 🌐 Rust | 📅 2026-08-14 by [Paradigm](https://x.com/paradigm)
* [Echidna](https://github.com/crytic/echidna) ⭐ 3,167 | 🐛 103 | 🌐 Haskell | 📅 2026-08-14 by [Trail of Bits](https://x.com/trailofbits)
...
* [ItyFuzz](https://github.com/fuzzland/ityfuzz) ⭐ 1,110 | 🐛 63 | 🌐 Rust | 📅 2025-12-10 by [fuzzland](https://x.com/fuzzland_)
* [Wake](https://github.com/Ackee-Blockchain/wake) ⭐ 373 | 🐛 37 | 🌐 Python | 📅 2026-06-21 by [Ackee](https://x.com/AckeeBlockchain)
* [Recon Fuzzer](https://github.com/Recon-Fuzz/recon-fuzzer) ⭐ 18 | 🐛 0 | 🌐 Rust | 📅 2026-07-28 by [Recon](https://x.com/getreconxyz)

## Tooling

### Libraries & Frameworks

* [Chimera](https://github.com/Recon-Fuzz/chimera) ⭐ 163 | 🐛 2 | 🌐 Solidity | 📅 2026-04-24 - Smart Contract Property-Based Testing Framework, by [Recon](https://x.com/getreconxyz)
...
* [fuzz-utils](https://github.com/crytic/fuzz-utils) ⭐ 116 | 🐛 19 | 🌐 Solidity | 📅 2025-08-25 - Set of Python tools to improve the developer experience when using smart contract fuzzing, by [Trail of Bits](https://x.com/trailofbits)
...
* [CloudExec](https://github.com/crytic/cloudexec) ⭐ 23 | 🐛 21 | 🌐 Go | 📅 2026-01-15 - A general purpose foundation for cloud-based fuzzing, by [Trail of Bits](https://x.com/trailofbits)
...
* [echidna-trace-parser](https://github.com/Enigma-Dark/fuzz-trace-parser) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2025-04-14 - A parser that converts echidna call traces into foundry PoC tests, by [Enigma Dark](https://x.com/EnigmadarkLabs)
* [Osiris Lite](https://github.com/Enigma-Dark/osiris-lite) ⭐ 8 | 🐛 0 | 🌐 Go | 📅 2025-08-28 - CLI tool for managing remote fuzzing jobs, by [Enigma Dark](https://x.com/EnigmadarkLabs)
...
* [Fizz](https://github.com/pashov/skills/tree/main/fizz) ⭐ 1,071 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-09 - AI skill for generating Solidity fuzzing suites, by [Pashov Audit Group](https://x.com/PashovAuditGrp)
...
* [List of Public Fuzzing Campaigns](https://github.com/perimetersec/public-fuzzing-campaigns-list) ⭐ 129 | 🐛 0 | 📅 2026-01-24 by [Rappie](https://x.com/rappie_eth)
* [Reproduction of the $41M Curve reentrancy hacks on July 30 2023 using on-chain fuzzing with Echidna](https://github.com/rappie/echidna-curve-reentrancy-hack) ⭐ 29 | 🐛 0 | 🌐 Solidity | 📅 2024-07-15 by [Rappie](https://x.com/rappie_eth)
* [Reproduction of the $80M Rari Finance Hack on April 30 2022 using on-chain fuzzing with Echidna](https://github.com/rappie/echidna-rari-hack) ⭐ 15 | 🐛 0 | 🌐 Solidity | 📅 2024-06-16 by [Rappie](https://x.com/rappie_eth)
* [Fuzzer Gas Metric Benchmark](https://github.com/rappie/fuzzer-gas-metric-benchmark) ⭐ 0 | 🐛 0 | 🌐 Solidity | 📅 2025-08-03 by [Rappie](https://x.com/rappie_eth)
...
* [Echidna Tutorial](https://github.com/crytic/building-secure-contracts/tree/master/program-analysis/echidna) ⭐ 2,477 | 🐛 58 | 🌐 Solidity | 📅 2026-04-13 by [Trail of Bits](https://x.com/trailofbits)
...
* [Awesome Fuzzing](https://github.com/secfigo/Awesome-Fuzzing) ⭐ 5,892 | 🐛 10 | 📅 2024-04-03 - A curated list of fuzzing resources for learning Fuzzing, by [Mohammed A. Imran](https://x.com/secfigo)
